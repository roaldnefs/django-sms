...
#### SMSAPI backend
The [SMSAPI](https://smsapi.pl/) backend sends text messages using the [SMSAPI.pl API python client](https://github.com/smsapi/smsapi-python-client). To specify this backend, put the following in your settings:
